      ...
      <div className="page">
        <div className="header">
          <div className="container">
            <p className="title">Privacy Policy for Fedhub Unite</p>
          </div>
        </div>
          ...
          <div className="container">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Application</strong> refers to Unite, the software
                ...
                <li>
                  <p>
                    ...
                    in this Agreement) refers to Fedhub, 40 , chaprathi village.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Fedhub Unite, accessible
                    from{" "}
                    <a
                      href="https://fedhub-unite.vercel.app/"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://fedhub-unite.vercel.app/
                    </a>
                  </p>
                </li>
                <li>
              ...
              <p>
                ...
                with the Company through Your Third-Party Social Media Service
                {``}s account. If You choose to provide such information and
              ...
              <p>
                ...
                uploaded to the Company{``}s servers and/or a Service Provider
                {``}s server or it may be simply stored on Your device.
              </p>
              <p>
              ...
              <ul>
                <li>
                  ...
                  <a
                    ...
                    data-cfemail="3d54535b52135b585955485f7d5a505c5451135e5250"
                  >
                    [email&nbsp;protected]
                  </a>
                </li>
